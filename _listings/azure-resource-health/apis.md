...
- name: Azure Resource Health API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/availability/master/_listings/azure-resource-health/subscriptions-subscriptionid-providers-microsoft-resourcehealth-availabilitystatuses-get.md
x-common:
- type: x-faq
